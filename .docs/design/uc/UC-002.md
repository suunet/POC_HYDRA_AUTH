...
| 外部連携 | EXT-01（メールサーバー・`adapters/mail/smtp.go`）・EXT-02（Redis・`adapters/ratelimit/registration.go`＋`common/ratelimit/fixedwindow.go`） |
